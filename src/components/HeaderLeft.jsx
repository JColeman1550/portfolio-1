...
import { BiMoon, BiSun, BiCurrentLocation, BiEnvelope, BiLogoGithub, BiLogoLinkedin, BiLogoTwitter} from 'react-icons/bi'
         ...
         dark:bg-black dark:text-white sm:border-r dark:border-gray-700"> 
            ...
            justify-center gap-5">
                 ...
                 drak:border-gray-700">
                    ...
                    <h1 className="text-baes font-semibold 
                    md:text-2x1">SOCIAL MEDIA</h1>
                ...
                <li className="flex-items-center gap-2">
                        ...
                        <span><a href="https://github.com/JColeman1550">
                        @JColeman1550</a></span>
                    </li> 
                    ...
                    <li className="flex-items-center gap-2">
                        ...
                        <span><a href="https://www.linkedin.com/in/juliantcoleman/">
                        juliantcoleman</a></span>
                    </li> 

                    <li className="flex-items-center gap-2">
                        
                        <BiLogoTwitter className="text-xl"/> 
                        <span><a href="https://x.com/Julian__TD">
                        Julian__TD</a></span>
                    </li>
                </ul>
            </div>

<div className="flex flex-col items-start justoify-start
    gap-5 border-b p-5 dark: border-gray-700">

<h1 className="text-baes font-semibold 
md:text-2x1">EDUCATION</h1>
...
before:bg-black dark:before:bg-white before:transform">
    <span className="font-semibold md:text-lg">Political Science</span>
    <span className="font-light">University of Southern California</span>
...
before: -translate-y1/2 before:rounded-full 
before:bg-black dark:before:bg-white before:transform">
    <span className="font-semibold md:text-lg">Certified Entry-Level Python Programmer</span>
